<head>
	...
	<link href="{{ asset('templates/templateAdmin/assets/css/default/app.min.css') }}" rel="stylesheet" />
	<!-- ================== END BASE CSS STYLE ================== -->

	<!-- ================== BEGIN PAGE LEVEL CSS STYLE ================== -->
	<link href="{{ asset('templates/templateAdmin/assets/plugins/jvectormap-next/jquery-jvectormap.css') }}" rel="stylesheet" />
