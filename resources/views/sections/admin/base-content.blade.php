<div id="content" class="content">
			...
			<div class="row">
				<!-- box 1ere ligne 1ere colonne totale competence -->
                    <div class="col-sm-6">
							<!-- begin card -->
				...
				<div class="col-xl-6">
					...
					<div class="row">
						...
						<!-- box 1ere ligne 2e colonne taux de conversion -->
						<div class="col-sm-6">
							<!-- begin card -->
							<div class="card border-0 text-truncate mb-3 bg-dark text-white">
								<!-- begin card-body -->
						...
						<!-- box 1ere ligne 3e colonne store sessions -->
						<div class="col-sm-6">
							<!-- begin card -->
							<div class="card border-0 text-truncate mb-3 bg-dark text-white">
								<!-- begin card-body -->
			...
			<!-- 2e ligne -->
			<div class="row">
				<!-- box 2e ligne 1ere colone visitors analytique -->
				...
				<!-- box 2e ligne 2e colonne cartographie-->
						...
						<div class="card-body">
							...
							<div>
								<div class="d-flex align-items-center text-white mb-2">
									<div class="widget-img widget-img-xs rounded bg-inverse mr-2 width-40" style="background-image: url(templates/templateAdmin/img/flag/us.jpg)"></div>
								...
								<div class="d-flex align-items-center text-white mb-2">
									<div class="widget-img widget-img-xs rounded bg-inverse mr-2 width-40" style="background-image: url(templates/templateAdmin/img/flag/cn.jpg)"></div>
									<div class="d-flex w-100">
										<div>China</div>
								...
								<div class="d-flex align-items-center text-white mb-2">
									<div class="widget-img widget-img-xs rounded bg-inverse mr-2 width-40" style="background-image: url(templates/templateAdmin/img/flag/de.jpg)"></div>
									<div class="d-flex w-100">
										<div>Germany</div>
								...
								<div class="d-flex align-items-center text-white mb-2">
									<div class="widget-img widget-img-xs rounded bg-inverse mr-2 width-40" style="background-image: url(templates/templateAdmin/img/flag/fr.jpg)"></div>
									<div class="d-flex w-100">
										<div>France</div>
								...
								<div class="d-flex align-items-center text-white mb-0">
									<div class="widget-img widget-img-xs rounded bg-inverse mr-2 width-40" style="background-image: url(templates/templateAdmin/img/flag/jp.jpg)"></div>
									<div class="d-flex w-100">
										<div>Japan</div>
			...
			<div class="row">
				...
				<!-- box 3e ligne 1ere colonne sales by socials-->
				<div class="col-xl-4 col-lg-6">
					<!-- begin card -->
					<div class="card border-0 mb-3 bg-dark-darker text-white">
						<!-- begin card-body -->
						<div class="card-body" style="background: no-repeat bottom right; background-image: url(templates/templateAdmin/img/svg/img-4.svg); background-size: auto 60%;">
							<!-- begin title -->
							<div class="mb-3 text-grey">
				...
				<!--box 3e ligne 2e colonne top produits-->
				<div class="col-xl-4 col-lg-6">
					<!-- begin card -->
					<div class="card border-0 mb-3 bg-dark text-white">
						<!-- begin card-body -->
						<div class="card-body">
							...
							<div class="d-flex align-items-center m-b-15">
								<div class="widget-img rounded-lg m-r-10 bg-white p-3 width-30">
									<div class="h-100 w-100" style="background: url(templates/templateAdmin/img/product/product-8.jpg) center no-repeat; background-size: auto 100%;"></div>
								</div>
							...
							<div class="d-flex align-items-center m-b-15">
								<div class="widget-img rounded-lg m-r-10 bg-white p-3 width-30">
									<div class="h-100 w-100" style="background: url(templates/templateAdmin/img/product/product-9.jpg) center no-repeat; background-size: auto 100%;"></div>
								</div>
								<div class="text-truncate">
							...
							<div class="d-flex align-items-center m-b-15">
								<div class="widget-img rounded-lg m-r-10 bg-white p-3 width-30">
									<div class="h-100 w-100" style="background: url(templates/templateAdmin/img/product/product-10.jpg) center no-repeat; background-size: auto 100%;"></div>
								</div>
								<div class="text-truncate">
							...
							<div class="d-flex align-items-center m-b-15">
								<div class="widget-img rounded-lg m-r-10 bg-white p-3 width-30">
									<div class="h-100 w-100" style="background: url(templates/templateAdmin/img/product/product-11.jpg) center no-repeat; background-size: auto 100%;"></div>
								</div>
								<div class="text-truncate">
							...
							<div class="d-flex align-items-center">
								<div class="widget-img rounded-lg m-r-10 bg-white p-3 width-30">
									<div class="h-100 w-100" style="background: url(templates/templateAdmin/img/product/product-12.jpg) center no-repeat; background-size: auto 100%;"></div>
								</div>
								<div class="text-truncate">
				...
				<!-- 3e box en bas a droite marketing  -->
				<div class="col-xl-4 col-lg-6">
					<!-- begin card -->
					<div class="card border-0 mb-3 bg-dark text-white">
						<!-- begin card-body -->
						<div class="card-body">
							...
							<div class="row align-items-center p-b-1">
								...
								<div class="col-4">
									<div class="height-100 d-flex align-items-center justify-content-center">
										<img src="templates/templateAdmin/img/svg/img-2.svg" class="mw-100 mh-100" />
									</div>
								</div>
								<!-- end col-4 -->
								<!-- begin col-8 -->
							...
							<div class="row align-items-center">
								...
								<div class="col-4">
									<div class="height-100 d-flex align-items-center justify-content-center">
										<img src="templates/templateAdmin/img/svg/img-3.svg" class="mw-100 mh-100" />
									</div>
								</div>
								<!-- end col-4 -->
								<!-- begin col-8 -->
