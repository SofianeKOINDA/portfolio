...
class StoreProjetRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'photo1' => 'nullable|image|mimes:jpeg,png,jpg,gif,webp|max:5048',
            'photo2' => 'nullable|image|mimes:jpeg,png,jpg,gif,webp|max:5048',
            'photo3' => 'nullable|image|mimes:jpeg,png,jpg,gif,webp|max:5048',
